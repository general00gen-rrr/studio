                ...
                <div className="py-5">
                  {activeTab === 'details' ? (
                    <div className="space-y-4">
                      {product.description && (
                        <p className="text-lux-gray text-sm leading-[1.8] font-light border-l-2 border-gold/30 pl-4" style={{whiteSpace:"pre-wrap",wordBreak:"break-word"}}>{product.description}</p>
                      )}
