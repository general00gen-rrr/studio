...
export default async function HomePage() {
  ...
  return (
    <div className="pt-0 bg-white">
      ...
      {/* BEST SELLERS (تصميم متمركز ومحتوى احترافي بدون أي فراغ) */}
      {best.length > 0 && (
          ...
          <div className="container-lux relative z-10">
            <ScrollReveal direction="up">
              <div className="mb-12 text-center max-w-xl mx-auto">
                <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-sky-500/10 border border-sky-400/30 text-cyan-300 text-xs font-bold mb-3">
                ...
                <p className="text-slate-400 text-sm mt-2">حلول جربها واعتمدها مئات العملاء في كافة أرجاء المملكة</p>
              </div>
            </ScrollReveal>

            {/* Centered Grid with ProductCard */}
            ...
            <div className="text-center mt-12">
              <Link href="/products?badge=bestseller" className="btn-aqua inline-flex items-center gap-2 px-8 py-3.5 rounded-xl text-xs font-bold">
                <span>تصفح جميع الأجهزة الأكثر مبيعاً</span>
                <svg className="w-4 h-4 rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
              </Link>
            </div>
          </div>
